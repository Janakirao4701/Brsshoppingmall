    ...
    <header className="h-16 flex items-center justify-between px-8 bg-white shadow-[0_1px_0_0_rgba(0,0,0,0.08)] sticky top-0 z-10">
      <div className="flex-1 max-w-md relative">
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
          <kbd className="hidden sm:inline-flex items-center justify-center rounded bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.08)] px-1.5 font-mono text-[10px] font-medium text-[#888888]">
            Ctrl
          </kbd>
          <kbd className="hidden sm:inline-flex items-center justify-center rounded bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.08)] px-1.5 font-mono text-[10px] font-medium text-[#888888]">
            K
